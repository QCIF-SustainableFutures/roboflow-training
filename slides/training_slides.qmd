...
## Why this workshop
- WildObs
  - A national platform for camera trap monitoring. Supported by many organisations. In development. 2024-2026. 
  - Primary Objective: Staff training - understand the background of computer vision models that will be used in WildObs. 
  - Secondary Objective: WildObs may want to use Roboflow tools (e.g.,Python SDK) for model development and model deployment.
- DETSI
  - QCIF is supporting DETSI to develop an -inhouse- computer vision model for key QLD wildlife species. Feb - Sept 2025. PSP Advance Qld project. 
